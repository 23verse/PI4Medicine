...
oDefineRGB <- function(data=NULL, entity=c("SNP","chr:start-end","data.frame","bed","GRanges"), include.RGB=NA, GR.SNP=c("dbSNP_Common","dbSNP_GWAS"), verbose=TRUE, placeholder=NULL, guid=NULL)
{
